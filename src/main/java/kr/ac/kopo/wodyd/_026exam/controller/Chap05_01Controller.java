...
public class Chap05_01Controller {
    ...
    @GetMapping("/chap0502")
    public String requestMethod2(@RequestParam(value = "id", defaultValue = "관리자") String userId, @RequestParam("passwd") String userPwd, Model model){
        model.addAttribute("userId", userId);
        model.addAttribute("userPwd", userPwd);
        return "viewPage05_01";
    }
    ...
    public String requestMethod3(@PathVariable("id") String userId, @MatrixVariable("passpwd") String userPwd, Model model){
        model.addAttribute("userId", userId);
        model.addAttribute("userPwd", userPwd);
        return "viewPage05_01";
    }
